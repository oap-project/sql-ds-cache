...
class ParquetFilterPredicateConvertor {
  ...
  private static JsonNode constructTree(FilterPredicate predicate) {
    ...
    if (predicate instanceof Operators.Not) {
      ...
      ((ObjectNode) rootNode).put("child", constructTree(((Operators.Not) predicate).getPredicate()));
    } else if (predicate instanceof Operators.And) {
      ((ObjectNode) rootNode).put("FilterTypeName", predicate.getClass().getSimpleName().toLowerCase());
      ((ObjectNode) rootNode).put("LeftNode", constructTree(((Operators.And) predicate).getLeft()));
      ((ObjectNode) rootNode).put("RightNode", constructTree(((Operators.And) predicate).getRight()));
    } else if (predicate instanceof Operators.Or) {
      ((ObjectNode) rootNode).put("FilterTypeName", predicate.getClass().getSimpleName().toLowerCase());
      ((ObjectNode) rootNode).put("LeftNode", constructTree(((Operators.Or) predicate).getLeft()));
      ((ObjectNode) rootNode).put("RightNode", constructTree(((Operators.Or) predicate).getRight()));
      ...
      ((ObjectNode) rootNode).put("ColumnType", ((Operators.Lt) predicate).getValue().getClass().getSimpleName());
      ((ObjectNode) rootNode).put("Value", ((Operators.Lt) predicate).getValue().toString());
    } else if (predicate instanceof Operators.LtEq) {
      ((ObjectNode) rootNode).put("FilterTypeName", predicate.getClass().getSimpleName().toLowerCase());
      ((ObjectNode) rootNode).put("ColumnName",
              ((Operators.LtEq) predicate).getColumn().getColumnPath().toDotString());
      ((ObjectNode) rootNode).put("ColumnType", ((Operators.LtEq) predicate).getValue().getClass().getSimpleName());
      ((ObjectNode) rootNode).put("Value", ((Operators.LtEq) predicate).getValue().toString());
      ...
      ((ObjectNode) rootNode).put("ColumnType", ((Operators.Gt) predicate).getValue().getClass().getSimpleName());
      ((ObjectNode) rootNode).put("Value", ((Operators.Gt) predicate).getValue().toString());
