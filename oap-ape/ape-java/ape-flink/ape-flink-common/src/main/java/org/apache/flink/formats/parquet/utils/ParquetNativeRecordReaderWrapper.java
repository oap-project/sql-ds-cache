...
/** A helper class to wrap API of native parquet reader. */
public class ParquetNativeRecordReaderWrapper implements ParquetRecordReaderWrapper {
    ...
    protected void initialize(
            Configuration hadoopConfig, RowType projectedType, FileSourceSplit split)
            throws IOException {
        ...
        // schema
        RequestedSchemaJsonConvertor message =
                new RequestedSchemaJsonConvertor(fieldTypeList, projectedFields);
        ...
        LOG.info(
                "native parquet reader initialized, plasma cache: {},  "
