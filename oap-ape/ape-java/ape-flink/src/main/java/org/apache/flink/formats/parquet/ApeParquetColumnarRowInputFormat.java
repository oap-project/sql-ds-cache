...
public class ApeParquetColumnarRowInputFormat<SplitT extends FileSourceSplit> extends
    ...
    private static class ColumnarRowReaderBatch extends ParquetReaderBatch<RowData> {
        ...
        private ColumnarRowReaderBatch(
            ...
            this.result = new ColumnarRowIterator(
                    new ColumnarRowData(columnarBatch), this::recycle);
        }
    ...
    /**
     * Create a partitioned {@link ApeParquetColumnarRowInputFormat}, the partition columns can be
     * generated by {@link Path}.
     */
    public static <SplitT extends FileSourceSplit> ApeParquetColumnarRowInputFormat<SplitT>
        ...
        return new ApeParquetColumnarRowInputFormat<>(
                hadoopConfig,
                projectedRowType,
                producedRowType,
                factory,
