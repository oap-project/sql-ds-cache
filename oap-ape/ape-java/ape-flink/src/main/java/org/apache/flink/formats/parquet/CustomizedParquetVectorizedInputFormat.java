...
public abstract class CustomizedParquetVectorizedInputFormat<T, SplitT extends FileSourceSplit>
    ...
    public ParquetReader restoreReader(final Configuration config, final SplitT split) throws IOException {
        ...
        Preconditions.checkArgument(checkpointedPosition.getOffset() == CheckpointedPosition.NO_OFFSET,
     ...
     */
    protected abstract ParquetReaderBatch<T> createReaderBatch(WritableColumnVector[] writableVectors,
    ...
    protected abstract static class ParquetReaderBatch<T> {
        ...
        protected ParquetReaderBatch(WritableColumnVector[] writableVectors, VectorizedColumnBatch columnarBatch,
                Pool.Recycler<ParquetReaderBatch<T>> recycler) {
