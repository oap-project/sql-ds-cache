 ...
 */
public class ApeTaskManagerServices {
    private static final Logger LOG = LoggerFactory.getLogger(ApeTaskManagerServices.class);
    ...
    public static TaskManagerServices fromConfiguration(
        ...
        if (numaBindingPathsEnabled) {
            String numaBindingPathOrdering =
                    taskManagerServicesConfiguration
                            .getConfiguration()
                            .get(ApeYarnOptions.NUMA_BINDING_PATH_ORDERING);
            Integer numaBindingPathMaxPercent =
                    taskManagerServicesConfiguration
                            .getConfiguration()
                            .get(ApeYarnOptions.NUMA_BINDING_PATH_MAX_PERCENT);
            ioManager =
                    new ApeIOManagerAsync(
