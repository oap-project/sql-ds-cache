...
public class YarnJobClusterEntrypointApe extends JobClusterEntrypoint {
    ...
    public static void main(String[] args) {
        ...
        EnvironmentInformation.logEnvironmentInfo(
                LOG, YarnJobClusterEntrypointApe.class.getSimpleName(), args);
        ...
        YarnJobClusterEntrypointApe yarnJobClusterEntrypoint =
                new YarnJobClusterEntrypointApe(configuration);
