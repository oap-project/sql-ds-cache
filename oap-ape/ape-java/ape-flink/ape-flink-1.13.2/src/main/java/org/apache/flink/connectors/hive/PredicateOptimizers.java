        ...
        private FilterPredicate notEquals(Tuple2<Operators.Column, Comparable> columnPair) {
            if (columnPair.f0 instanceof Operators.IntColumn) {
                return FilterApi.notEq(
                        (Operators.IntColumn) columnPair.f0, (Integer) columnPair.f1);
                ...
                return FilterApi.notEq(
                        (Operators.DoubleColumn) columnPair.f0, (Double) columnPair.f1);
            } else if (columnPair.f0 instanceof Operators.FloatColumn) {
                return FilterApi.notEq(
                        (Operators.FloatColumn) columnPair.f0, (Float) columnPair.f1);
                ...
                return FilterApi.notEq(
                        (Operators.BinaryColumn) columnPair.f0, (Binary) columnPair.f1);
            }
