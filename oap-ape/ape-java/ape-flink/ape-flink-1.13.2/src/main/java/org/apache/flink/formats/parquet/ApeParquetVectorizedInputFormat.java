...
public abstract class ApeParquetVectorizedInputFormat<T, SplitT extends FileSourceSplit>
    ...
    public ApeParquetVectorizedInputFormat(
        ...
        useNativeParquetReader =
                hadoopConfig.conf().getBoolean(ApeParquetConfKeys.USE_NATIVE_PARQUET_READER, false);
    }
    ...
    public ParquetReader createReader(final Configuration config, final SplitT split)
        ...
        FilterPredicate predicate =
                SerializationUtil.readObjectFromConfAsBase64(
        ...
        if (useNativeParquetReader) {
            ...
            nativeReaderWrapper.initialize(
                    hadoopConfig.conf(), projectedType, split, predicate, aggStr);
            if (aggStr != null) {
        ...
        return new ParquetReader(
                reader, requestedSchema, totalRowCount, poolOfBatches, nativeReaderWrapper);
    }
    ...
    private ParquetReaderBatch<T> createReaderBatch(
        ...
        if (!useNativeParquetReader) {
            ...
            // native parquet reader is optional
            writableVectors =
                    nativeReaderWrapper.initBatch(requestedSchema, batchSize, projectedType);
        }
