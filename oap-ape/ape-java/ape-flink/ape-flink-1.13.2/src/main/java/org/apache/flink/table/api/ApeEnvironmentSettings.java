...
public class ApeEnvironmentSettings {
    ...
    /** Creates an instance of {@link ApeEnvironmentSettings} from {@link Configuration}. */
    public static ApeEnvironmentSettings fromConfiguration(Configuration configuration) {
