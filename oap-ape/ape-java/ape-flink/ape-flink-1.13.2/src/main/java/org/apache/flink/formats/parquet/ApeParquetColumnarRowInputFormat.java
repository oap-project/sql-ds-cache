 ...
 */
public class ApeParquetColumnarRowInputFormat<SplitT extends FileSourceSplit>
        extends ApeParquetVectorizedInputFormat<RowData, SplitT> {
    ...
    public static <SplitT extends FileSourceSplit>
            ApeParquetColumnarRowInputFormat<SplitT> createPartitionedFormat(
                    Configuration hadoopConfig,
