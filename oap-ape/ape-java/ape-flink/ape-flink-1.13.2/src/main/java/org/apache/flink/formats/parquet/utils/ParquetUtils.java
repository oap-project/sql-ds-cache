...
public class ParquetUtils {
    ...
    /** Inner class for required groups. */
    ...
    public static RequiredRowGroups getRequiredSplitRowGroups(
        ...
        RequiredRowGroups ret =
                filterRowGroupsByMidpoint(
                        readFileMetaData(footerBytesStream), splitStart, splitStart + splitSize);
    ...
    private static InputStream getFooterBytesStream(
        ...
        if (fileLen < MAGIC.length + footerLengthSize + MAGIC.length) {
            ...
            throw new RuntimeException(
                    file.toString() + " is not a Parquet file (too small length: " + fileLen + ")");
        }

        long footerLengthIndex = fileLen - footerLengthSize - MAGIC.length;
