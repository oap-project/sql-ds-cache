...
public class ApeNettyShuffleServiceFactory
    ...
    static NettyShuffleEnvironment createNettyShuffleEnvironment(
        ...
        boolean numaBindingPathsEnabled =
                nettyConfig.getConfig().get(ApeYarnOptions.NUMA_BINDING_PATH_ENABLED);
        if (numaBindingPathsEnabled) {
            String numaBindingPathOrdering =
                    nettyConfig.getConfig().get(ApeYarnOptions.NUMA_BINDING_PATH_ORDERING);
            Integer numaBindingPathMaxPercent =
                    nettyConfig.getConfig().get(ApeYarnOptions.NUMA_BINDING_PATH_MAX_PERCENT);
            fileChannelManager =
                    new ApeFileChannelManagerImpl(
                            config.getTempDirs(),
                            DIR_NAME_PREFIX,
